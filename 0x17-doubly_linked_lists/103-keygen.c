...
/**
 * main - This will generate a key for crackme5 program
 * @argc: No.of arguments that were passed
 * @argv: Arguments that were passed
 *
 * Return: 0 if successful,if fails 1
 */
...
/**
 * f4 - Computes fourth character in the key for the given username
 * @str: variable for username
 * @len: Length for username
 *
 * Return: calculated char
 */
int f4(char *str, int len)
{
